@echo off
REM ============================================================
REM  AES Controller - Restore Standard Arduino Firmware
...
echo.
echo ============================================================
echo   Restore Standard Arduino Mode
echo ============================================================
echo.
...
echo.
echo Restoring standard Arduino firmware...
echo.
...
echo.
echo ============================================================
echo   SUCCESS! Standard Arduino firmware restored.
echo ============================================================
echo.
...
echo  4. Windows will show it as a normal Arduino
echo.
