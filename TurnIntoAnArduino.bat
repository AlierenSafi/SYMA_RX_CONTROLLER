@echo off
REM ============================================================
REM  AES Controller - Arduino Moduna Donus
...
echo.
echo Normal Arduino firmware yukleniyor...
echo.
...
echo.
echo ============================================================
echo   BASARILI! Arduino firmware yuklendi.
echo ============================================================
echo.
...
echo  4. Windows'ta normal Arduino olarak gorunecek
echo.
